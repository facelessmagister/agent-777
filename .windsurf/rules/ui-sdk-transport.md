...
description: how to use The useChat transport system to provide fine-grained control over how messages are sent to your API endpoints and how responses are processed
---
